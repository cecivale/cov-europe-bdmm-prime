...
# args$args = "/Users/maceci/210205_europe10/results/europeC/210205_europe10.10000.TL.traj"
...
## First imported cases into Europe, time and location
...
first_eu10 <- ggarrange(first_eu10d, first_eu10s, labels = chartr("123456789", "ABCDEFGHI", 1:3), font.label = list(size = 8), nrow = 1, ncol = 2, hjust = -7, vjust = 2)
ggexport(first_eu10,
         filename = paste0(args$output_figure, "05.png"),
         width = 2000, height = 1200, res = 300)

first_eu_all <- ggarrange(first_eu, first_eu10d, first_eu10s, labels = chartr("123456789", "ABCDEFGHI", 1:3), font.label = list(size = 9), nrow = 1, ncol = 3, hjust = -6, vjust = 2)
first_eu_all
ggexport(first_eu_all,
         filename = paste0(args$output_figure, "0405.png"),
