...
# #args$input = "./results/europeC/201211_europe6p2.TL.traj"
# args$input = "/Users/maceci/210205_europe10/results/europeC/210205_europe10.10000.TL.traj"
...
first_eu <- ggplot(first_df1, aes(x = date, y = ..count../(m*args$n))) +
  geom_density_line(
...
first_dest <- ggplot(first_df10, aes(x = date, y = ..count../(m*args$n))) +
  geom_density_line(
...
first_source <- ggplot(first_df10, aes(x = date, y = ..count../(m*args$n))) +
  geom_density_line(
    data = select(first_df10, -deme), aes(fill = NA),
    color = "transparent", alpha = 0.8, bw = 2
  ) + 
...
ggexport(inc_plot,
         filename = paste0(args$output_figure, "12.png"),
         width = 2000, height = 1200, res = 300)
```
...
ggexport(events_timingplot,
         filename = paste0(args$output_figure, "13.png"),
         width = 2000, height = 1200, res = 300)
