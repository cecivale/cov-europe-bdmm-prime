...
\bottomrule
\end{tabular}
\caption{Caption. Source of case data. \todo[inline]{TODO. Vertical alignment}}
\label{table:priors}
\end{table}

\textbf{Data availability}
The SARS-CoV-2 genetic data can be downloaded from www.gisaid.org. Supplementary Table \ref{stable:seqs} lists accession numbers for the genetic sequences used in this study. Reported SARS-CoV-2 case counts are obtained from the country official agencies indicated in Table \ref{table:cases}. Flight data can be obtained from EUROSTATS https://ec.europa.eu/eurostat/.
