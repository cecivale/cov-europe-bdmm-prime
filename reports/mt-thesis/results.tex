...
\textbf{Origin of the first wave in Europe} 
While the first cases in Europe were reported in mid-January, it is likely that the first European wave started earrlier and due to the lack of knowledge confusson  of the disease it was not detected by the surveillance systems.  We assume the origin case to be an imported case from China into Europe. We analyze the time and destination of the first imported case into any of the European countries of our infered epidemic trajectories and estimate the origin of the European epidemic on January 2020 ($95\%$ CCI). Location Italy or France. Figure \ref{fig:firstEUcase}. It is possible that several imported cases from China started the local transmission in the different Euorpean countries that a single imported case. So we cna look into the first imported cases in Europe and from its probability distribution the first scenario looks more likely, with most of these first introduction witht origin in China and like when looking at just one case they were more to Italy and France, but alos Germany. Earlly introductions in Spain have a very low probabilty, looking like Spain was not a key player in the orrigin of SARS-CoV-2 in Europe.
...
\textbf{First cases in European countries}
...
\textbf{Detection timing and response}
...
\textbf{Interational transmission patterns}
